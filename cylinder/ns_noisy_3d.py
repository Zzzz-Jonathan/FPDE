import os
import torch
from num_3d import loss_pde, loss_data, loss_icbc
...
Furthermore, running this program is training the PINN using the given noisy data.
It is named ns_noisy_3d because the input to the network is three-dimensional (t, x, y), the governed equations 
is N-S eq, and the training data has artificial noise added.
...
PDE loss and other losses are defined in cylinder/num_3d.py. Noisy dataloader and data processing related comments are 
...
path = 'train_history/noisy/' + str(noisy_num) + '/no_filter'
