import os
import torch
from num_3d import loss_data, loss_fpde, loss_icbc, x_star, y_star
...
running this program is training the FPDE network using the given sparse data.
It is named les_3d because the input to the network is three-dimensional (t, x, y).
...
FPDE loss and other losses are defined in cylinder/num_3d.py. Sparse dataloader and data processing related comments are 
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, EPOCH):
        for t_x_y, num_solution in dataloader:
            ...
            loss_u, loss_v, loss_div = loss_fpde(NN, t_x_y, dx=filter_dx, dy=filter_dy)  # + loss_les(NN_les, t_x_y_col)
